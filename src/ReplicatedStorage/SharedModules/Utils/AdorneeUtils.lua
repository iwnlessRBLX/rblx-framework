...
function AdorneeUtils.getCenter(adornee): Vector3?
...
function AdorneeUtils.getBoundingBox(adornee): (CFrame, Vector3)
...
function AdorneeUtils.getParts(adornee): {BasePart}
	assert(typeof(adornee) == "Instance", "Adornee must by of type 'Instance'")
...
function AdorneeUtils.getAlignedSize(adornee): Vector3?
	if adornee:IsA("Model") then
...
function AdorneeUtils.getPartCFrame(adornee): CFrame?
	assert(typeof(adornee) == "Instance", "Adornee must by of type 'Instance'")
...
function AdorneeUtils.getPartPosition(adornee): Vector3?
	assert(typeof(adornee) == "Instance", "Adornee must by of type 'Instance'")
...
function AdorneeUtils.getPart(adornee): BasePart
	assert(typeof(adornee) == "Instance", "Adornee must by of type 'Instance'")
...
function AdorneeUtils.getRenderAdornee<T>(adornee: T): T
	assert(typeof(adornee) == "Instance", "Adornee must by of type 'Instance'")
